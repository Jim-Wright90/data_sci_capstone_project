...
library(forcats)
library(ggrepel)
library(gt) #not sure that you used {gt}; try to only load packages you are using (I didnt check all of them)
library(knitr)
library(kableExtra)
library(reactable)
library(plotly)
...
# all impact data 
# jftn: It doesn't look like you use this impact_all data

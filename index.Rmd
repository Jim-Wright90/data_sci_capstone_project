...
**Merged ImPACT and SIMS Data:** Differences in mean post-injury 1 symptom severity ratings between individuals, based on the number of post-injury tests completed, were significant or approximating significance for the following symptom clusters: Total Symptom score, Headache-Migraine Cluster, Cognitive Cluster, and the Vestibular Cluster. Pairwise comparisons with a Bonferroni correction identified no significant comparisons for the total symptom score and cognitive cluster score. Post-injury 1 symptom severity ratings of the headache-migraine cluster were significantly different between individuals who completed one and four post-injury tests. Additionally, post-injury 1 symptom severity ratings of the vestibular cluster were significantly different between individuals who completed one and four post-injury tests as well as two and four post-injury tests. 

**Non-Merged ImPACT Data:** Differences in mean post-injury 1 symptom severity ratings between individuals, based on the number of post-injury tests completed, was significant across all symptom clusters and the total symptom severity rating. On average, individuals who eventually completed more post-injury tests reported higher symptom severity at the time of post-injury 1 testing. All pairwise comparisons utilizing a Bonferroni correction were significant with the exception of the comparison of the post-injury 1 anxiety-mood cluster score between individuals who completed three and four post-injury tests. 
...
# bind non-merged data 

one_impact_bind <- one_impact_test %>% 
  select(3, 31, 32, 33, 34, 35, 36, 37)

two_impact_bind <- two_impact_test %>% 
  select(3, 57, 59, 61, 63, 65, 67, 69)

three_impact_bind <- three_impact_test %>% 
  select(3, 83, 86, 89, 92, 95, 98, 101)

four_impact_bind <- four_impact_test %>% 
  select(3, 109, 113, 117, 121, 125, 129, 133)

all_impact_bind <- bind_rows(one_impact_bind, 
                             two_impact_bind, 
                             three_impact_bind,
                             four_impact_bind,
                             .id = "number_tests")

all_impact_bind <- all_impact_bind %>% 
  mutate(number_tests = as.factor(number_tests))
...
### Merged Total Symptom Score Test 1 Summary 
...
### Merged Total Symptom Score Test 1 Boxplot Comparison 
...
### Merged Total Symptom Score Test 1 ANOVA 
...
### Merged Total Symptom Score Test 1 Pairwise Comparisons 
...
total_symptom_score_aov_pwc <- total_symptom_score_aov_pwc %>% 
  mutate_at(vars(p, p.adj), list(~ round(., 2)))
```
...
### Non-Merged Total Symptom Score Test 1 Summary 

```{r, include=TRUE}
symptom_smry_tbl(all_impact_bind, total_symptom_score_post_injury_1)
```

### Non-Merged Total Symptom Score Test 1 Boxplot Comparison 

```{r, include=TRUE}
ggplotly(test_1_bxp(all_impact_bind, number_tests, total_symptom_score_post_injury_1))
```

### Non-Merged Total Symptom Score Test 1 ANOVA 

```{r, include=FALSE}
total_symptom_score_aov_1 <- aov(total_symptom_score_post_injury_1 ~ number_tests, data = all_impact_bind)
```

```{r, include=TRUE}
summary(total_symptom_score_aov_1)
```

### Non-Merged Total Symptom Score Test 1 Pairwise Comparisons 

```{r, include=FALSE}
total_symptom_score_aov_pwc_1 <- all_impact_bind %>% 
  pairwise_t_test(
    total_symptom_score_post_injury_1 ~ number_tests, paired = FALSE,
    p.adjust.method = "bonferroni"
  )

total_symptom_score_aov_pwc_1 <- total_symptom_score_aov_pwc_1 %>% 
  mutate_at(vars(p, p.adj), list(~ round(., 2)))
```

```{r, include=TRUE}
total_symptom_score_aov_pwc_1 %>% 
  reactable()
```
...
### Merged Headache-Migraine Cluster Score Test 1 Summary

```{r, include=TRUE}
symptom_smry_tbl(all_impact_sims_bind, headache_migraine_cluster_score_post_injury_1)
```

### Merged Headache-Migraine Cluster Score Test 1 Boxplot Comparison 
...
### Merged Headache-Migraine Cluster Score Test 1 ANOVA 
...
### Merged Headache-Migraine Cluster Score Test 1 Pairwise Comparisons 
...
headache_migraine_cluster_score_aov_pwc <- headache_migraine_cluster_score_aov_pwc %>% 
  mutate_at(vars(p, p.adj), list(~ round(., 2)))
```
...
### Non-Merged Headache-Migraine Cluster Score Test 1 Summary 

```{r, include=TRUE}
symptom_smry_tbl(all_impact_bind, headache_migraine_cluster_score_post_injury_1)
```

### Non-Merged Headache-Migraine Cluster Score Test 1 Boxplot Comparison 

```{r, include=TRUE}
ggplotly(test_1_bxp(all_impact_bind, number_tests, headache_migraine_cluster_score_post_injury_1))
```

### Non-Merged Headache-Migraine Cluster Score Test 1 ANOVA 

```{r, include=FALSE}
headache_migraine_cluster_score_aov_1 <- aov(headache_migraine_cluster_score_post_injury_1 ~ number_tests, data = all_impact_bind)
```

```{r, include=TRUE}
summary(headache_migraine_cluster_score_aov_1)
```

### Non-Merged Headache-Migraine Cluster Score Test 1 Pairwise Comparisons 

```{r, include=FALSE}
headache_migraine_cluster_score_aov_pwc_1 <- all_impact_bind %>% 
  pairwise_t_test(
    headache_migraine_cluster_score_post_injury_1 ~ number_tests, paired = FALSE,
    p.adjust.method = "bonferroni"
  )

headache_migraine_cluster_score_aov_pwc_1 <- headache_migraine_cluster_score_aov_pwc_1 %>% 
  mutate_at(vars(p, p.adj), list(~ round(., 2)))
```

```{r, include=TRUE}
headache_migraine_cluster_score_aov_pwc_1 %>% 
  reactable()
```
...
### Merged Cognitive Cluster Score Test 1 Summary

```{r, include=TRUE}
symptom_smry_tbl(all_impact_sims_bind, cognitive_cluster_score_post_injury_1)
```

### Merged Cognitive Cluster Score Test 1 Boxplot Comparison 
...
### Merged Cognitive Cluster Score Test 1 ANOVA 
...
### Merged Cognitive Cluster Score Test 1 Pairwise Comparisons 
...
cognitive_cluster_score_aov_pwc <- cognitive_cluster_score_aov_pwc %>% 
  mutate_at(vars(p, p.adj), list(~ round(., 2)))
```
...
### Non-Merged Cognitive Cluster Score Test 1 Summary 

```{r, include=TRUE}
symptom_smry_tbl(all_impact_bind, cognitive_cluster_score_post_injury_1)
```

### Non-Merged Cognitive Cluster Score Test 1 Boxplot Comparison 

```{r, include=TRUE}
ggplotly(test_1_bxp(all_impact_bind, number_tests, cognitive_cluster_score_post_injury_1))
```

### Non-Merged Cognitive Cluster Score Test 1 ANOVA 

```{r, include=FALSE}
cognitive_cluster_score_aov_1 <- aov(cognitive_cluster_score_post_injury_1 ~ number_tests, data = all_impact_bind)
```

```{r, include=TRUE}
summary(cognitive_cluster_score_aov_1)
```

### Non-Merged Cognitive Cluster Score Test 1 Pairwise Comparisons 

```{r, include=FALSE}
cognitive_cluster_score_aov_pwc_1 <- all_impact_bind %>% 
  pairwise_t_test(
    cognitive_cluster_score_post_injury_1 ~ number_tests, paired = FALSE,
    p.adjust.method = "bonferroni"
  )

cognitive_cluster_score_aov_pwc_1 <- cognitive_cluster_score_aov_pwc_1 %>% 
  mutate_at(vars(p, p.adj), list(~ round(., 2)))
```

```{r, include=TRUE}
cognitive_cluster_score_aov_pwc_1 %>% 
  reactable()
```
...
### Merged Anxiety-Mood Cluster Score Test 1 Summary

```{r, include=TRUE}
symptom_smry_tbl(all_impact_sims_bind, anxiety_mood_cluster_score_post_injury_1)
```

### Merged Anxiety-Mood Cluster Score Test 1 Boxplot Comparison 
...
### Merged Anxiety-Mood Cluster Score Test 1 ANOVA 
...
### Merged Anxiety-Mood Cluster Score Test 1 Pairwise Comparisons 
...
anxiety_mood_cluster_score_aov_pwc <- anxiety_mood_cluster_score_aov_pwc %>% 
  mutate_at(vars(p, p.adj), list(~ round(., 2)))
```
...
### Non-Merged Anxiety-Mood Cluster Score Test 1 Summary 

```{r, include=TRUE}
symptom_smry_tbl(all_impact_bind, anxiety_mood_cluster_score_post_injury_1)
```

### Non-Merged Anxiety-Mood Cluster Score Test 1 Boxplot Comparison 

```{r, include=TRUE}
ggplotly(test_1_bxp(all_impact_bind, number_tests, anxiety_mood_cluster_score_post_injury_1))
```

### Non-Merged Anxiety-Mood Cluster Score Test 1 ANOVA 

```{r, include=FALSE}
anxiety_mood_cluster_score_aov_1 <- aov(anxiety_mood_cluster_score_post_injury_1 ~ number_tests, data = all_impact_bind)
```

```{r, include=TRUE}
summary(anxiety_mood_cluster_score_aov_1)
```

### Non-Merged Anxiety-Mood Cluster Score Test 1 Pairwise Comparisons 

```{r, include=FALSE}
anxiety_mood_cluster_score_aov_pwc_1 <- all_impact_bind %>% 
  pairwise_t_test(
    anxiety_mood_cluster_score_post_injury_1 ~ number_tests, paired = FALSE,
    p.adjust.method = "bonferroni"
  )

anxiety_mood_cluster_score_aov_pwc_1 <- anxiety_mood_cluster_score_aov_pwc_1 %>% 
  mutate_at(vars(p, p.adj), list(~ round(., 2)))
```

```{r, include=TRUE}
anxiety_mood_cluster_score_aov_pwc_1 %>% 
  reactable()
```
...
### Merged Ocular-Motor Cluster Score Test 1 Summary

```{r, include=TRUE}
symptom_smry_tbl(all_impact_sims_bind, ocular_motor_cluster_score_post_injury_1)
```

### Merged Ocular-Motor Cluster Score Test 1 Boxplot Comparison 
...
### Merged Ocular-Motor Cluster Score Test 1 ANOVA 
...
### Merged Ocular-Motor Cluster Score Test 1 Pairwise Comparisons 
...
ocular_motor_cluster_score_aov_pwc <- ocular_motor_cluster_score_aov_pwc %>% 
  mutate_at(vars(p, p.adj), list(~ round(., 2)))
```
...
### Non-Merged Ocular-Motor Cluster Score Test 1 Summary 

```{r, include=TRUE}
symptom_smry_tbl(all_impact_bind, ocular_motor_cluster_score_post_injury_1)
```

### Non-Merged Ocular-Motor Cluster Score Test 1 Boxplot Comparison 

```{r, include=TRUE}
ggplotly(test_1_bxp(all_impact_bind, number_tests, ocular_motor_cluster_score_post_injury_1))
```

### Non-Merged Ocular-Motor Cluster Score Test 1 ANOVA 

```{r, include=FALSE}
ocular_motor_cluster_score_aov_1 <- aov(ocular_motor_cluster_score_post_injury_1 ~ number_tests, data = all_impact_bind)
```

```{r, include=TRUE}
summary(ocular_motor_cluster_score_aov_1)
```

### Non-Merged Ocular-Motor Cluster Score Test 1 Pairwise Comparisons 

```{r, include=FALSE}
ocular_motor_cluster_score_aov_pwc_1 <- all_impact_bind %>% 
  pairwise_t_test(
    ocular_motor_cluster_score_post_injury_1 ~ number_tests, paired = FALSE,
    p.adjust.method = "bonferroni"
  )

ocular_motor_cluster_score_aov_pwc_1 <- ocular_motor_cluster_score_aov_pwc_1 %>% 
  mutate_at(vars(p, p.adj), list(~ round(., 2)))
```

```{r, include=TRUE}
ocular_motor_cluster_score_aov_pwc_1 %>% 
  reactable()
```
...
### Merged Vestibular Cluster Score Test 1 Summary

```{r, include=TRUE}
symptom_smry_tbl(all_impact_sims_bind, vestibular_cluster_score_post_injury_1)
```

### Merged Vestibular Cluster Score Test 1 Boxplot Comparison 
...
### Merged Vestibular Cluster Score Test 1 ANOVA 
...
### Merged Vestibular Cluster Score Test 1 Pairwise Comparisons 
...
vestibular_cluster_score_aov_pwc <- vestibular_cluster_score_aov_pwc %>% 
  mutate_at(vars(p, p.adj), list(~ round(., 2)))
```
...
### Non-Merged Vestibular Cluster Score Test 1 Summary 

```{r, include=TRUE}
symptom_smry_tbl(all_impact_bind, vestibular_cluster_score_post_injury_1)
```

### Non-Merged Vestibular Cluster Score Test 1 Boxplot Comparison 

```{r, include=TRUE}
ggplotly(test_1_bxp(all_impact_bind, number_tests, vestibular_cluster_score_post_injury_1))
```

### Non-Merged Vestibular Cluster Score Test 1 ANOVA 

```{r, include=FALSE}
vestibular_cluster_score_aov_1 <- aov(vestibular_cluster_score_post_injury_1 ~ number_tests, data = all_impact_bind)
```

```{r, include=TRUE}
summary(vestibular_cluster_score_aov_1)
```

### Non-Merged Vestibular Cluster Score Test 1 Pairwise Comparisons 

```{r, include=FALSE}
vestibular_cluster_score_aov_pwc_1 <- all_impact_bind %>% 
  pairwise_t_test(
    vestibular_cluster_score_post_injury_1 ~ number_tests, paired = FALSE,
    p.adjust.method = "bonferroni"
  )

vestibular_cluster_score_aov_pwc_1 <- vestibular_cluster_score_aov_pwc_1 %>% 
  mutate_at(vars(p, p.adj), list(~ round(., 2)))
```

```{r, include=TRUE}
vestibular_cluster_score_aov_pwc_1 %>% 
  reactable()
```
...
### Merged Sleep Cluster Score Test 1 Summary

```{r, include=TRUE}
symptom_smry_tbl(all_impact_sims_bind, sleep_cluster_score_post_injury_1)
```

### Merged Sleep Cluster Score Test 1 Boxplot Comparison 
...
### Merged Sleep Cluster Score Test 1 ANOVA 
...
### Merged Sleep Cluster Score Test 1 Pairwise Comparisons 
...
sleep_cluster_score_aov_pwc <- sleep_cluster_score_aov_pwc %>% 
  mutate_at(vars(p, p.adj), list(~ round(., 2)))
```
...
### Non-Merged Sleep Cluster Score Test 1 Summary 

```{r, include=TRUE}
symptom_smry_tbl(all_impact_bind, sleep_cluster_score_post_injury_1)
```

### Non-Merged Sleep Cluster Score Test 1 Boxplot Comparison 

```{r, include=TRUE}
ggplotly(test_1_bxp(all_impact_bind, number_tests, sleep_cluster_score_post_injury_1))
```

### Non-Merged Sleep Cluster Score Test 1 ANOVA 

```{r, include=FALSE}
sleep_cluster_score_aov_1 <- aov(sleep_cluster_score_post_injury_1 ~ number_tests, data = all_impact_bind)
```

```{r, include=TRUE}
summary(sleep_cluster_score_aov_1)
```

### Non-Merged Sleep Cluster Score Test 1 Pairwise Comparisons 

```{r, include=FALSE}
sleep_cluster_score_aov_pwc_1 <- all_impact_bind %>% 
  pairwise_t_test(
    sleep_cluster_score_post_injury_1 ~ number_tests, paired = FALSE,
    p.adjust.method = "bonferroni"
  )

sleep_cluster_score_aov_pwc_1 <- sleep_cluster_score_aov_pwc_1 %>% 
  mutate_at(vars(p, p.adj), list(~ round(., 2)))
```

```{r, include=TRUE}
sleep_cluster_score_aov_pwc_1 %>% 
  reactable()
```